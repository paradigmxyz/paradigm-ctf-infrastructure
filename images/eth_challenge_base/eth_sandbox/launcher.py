...
ANVIL_UNLOCK = "anvil_impersonateAccount"
ANVIL_LOCK = "anvil_stopImpersonatingAccount"
...
def send_tx(web3: Web3, tx: Dict, deployer: str) -> Optional[TxReceipt]:
    ...
    web3.provider.make_request(ANVIL_UNLOCK, [tx["from"]])
    txhash = web3.eth.sendTransaction(tx)
    web3.provider.make_request(ANVIL_LOCK, [tx["from"]])
